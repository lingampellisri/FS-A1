...
You can stop the wheel at any time, including before serving all customers. If you decide to stop serving customers, all subsequent rotations are free in 
order to get all the customers down safely. Note that if there are currently more than four customers waiting at the wheel, only four will board the gondola,
...
public class Wheel{
    public static void main(String[] args) {
        ...
        System.out.println(getMinRotations(customers,n,boardingCost,runningCost));
